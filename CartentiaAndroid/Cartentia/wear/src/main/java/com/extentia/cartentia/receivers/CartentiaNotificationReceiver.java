package com.extentia.cartentia.receivers;
...
public class CartentiaNotificationReceiver extends BroadcastReceiver {
    public static final String CONTENT_KEY = "contentText";

    public CartentiaNotificationReceiver() {
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        Intent displayIntent = new Intent(context, DashboardWearActivity.class);
