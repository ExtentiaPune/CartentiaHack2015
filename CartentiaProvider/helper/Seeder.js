...
PopulateDB.prototype.writeToDB = function(){
	return new Promise(function(resolve, reject){
		...
		var users = [{"ID":1,"name":"Ravi Verma","username":"nfcuser1","password":"user123","role":1,"parentID":null,"groupID":1,"regID":"APA91bE1A3XaWUFMmx5xjx4SSPmCWtaE98Tywetb_dknhu896PEkE626kxp07WS4KMuApxRzIGZzLJFmnllWyWsSh6yT9wP-HQ76mPo6pdcfwgcIOfrJE7oSOnD1j1rgyF8s353AqQJn"},{"ID":2,"name":"Ojas Sathe","username":"nfcuser2","password":"user123","role":2,"parentID":1,"groupID":1,"regID":"APA91bE1A3XaWUFMmx5xjx4SSPmCWtaE98Tywetb_dknhu896PEkE626kxp07WS4KMuApxRzIGZzLJFmnllWyWsSh6yT9wP-HQ76mPo6pdcfwgcIOfrJE7oSOnD1j1rgyF8s353AqQJn"}]
		...
		,function(callback){
			...
			cartModel.find({}, function(err, cartsIn){
				if(cartsIn.length == 0){
					if(locals[CONSTANT.SCHEMA.USER]){
